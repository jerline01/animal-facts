...
//         var fact = await fetch("https://zoo-animal-api.herokuapp.com/animals/rand");
//         var result = await fact.json();
//         console.log(result);
//         var img = document.createElement('img');
//         document.body.append(img);
//         for(var i in result) {
//             let ans = document.createElement('div');
//             ans.innerHTML = i+ ": " + result[i];
//             img.setAttribute('src',result.image_link);
